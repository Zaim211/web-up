      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row jsutify-between items-center w-full'>
          ...
          text-[52px] text-white ss:leading-[100px] leading-[75px]">
            Build anything <br className="sm:block hidden" /> {" "}
            <span className="text-gradient"> you want
            </span> {" "}
          </h1>
        ...
        We help drive your business forward faster, Gujarat. Find here details about our company.
        </p>
      </div>


      <div className={`flex-1 flex ${styles.flexStart}
      md:my-0 my-10 realtive`}>
