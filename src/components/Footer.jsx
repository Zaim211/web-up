    ...
    flex-col`}>
      ...
      flex-col mb-8 w-full`}>
        <div className="flex-1 flex flex-col justify-start mr-10">
          ...
          <p className="text-white">lOGO</p>lOGO
          <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>
            A new jhfsdjh jhsdfjh jdfh jdfhhj jhfh jhdfsh sd hjdf
            hjdfsdhj jhsfhsd jhdsfh
          </p>
        </div>

        <div className="flex flex-row flex-[1.5] w-full
      ...
      md:flex-row flex-col pt-6 border-t-[2px] border-t-[#3F3E45]">
